if ("undefined" == typeof psLib) var psLib = {};
(psLib.Chart = function (ctn) {
    var charts = $(".ps-chart", ctn),
        idx = 0;
    return charts.length > 0 && "undefined" == typeof Chart
        ? (console.warn("Biblioteca Chart necessária para construir formulário"), !1)
        : ((window.graph = []),
            void charts.each(function () {
                var t = $(this),
                    type = t.data("charttype"),
                    source = t.data("chartsource"),
                    download = "undefined" != typeof t.data("chartdownload") ? t.data("chartdownload") : !1,
                    config = "undefined" != typeof t.data("chartconfig") ? t.data("chartconfig") : !1,
                    w = t.outerWidth(),
                    h = "undefined" != typeof t.data("chartheight") ? t.data("chartheight") : 150 > w ? w : w / 2,
                    d = new Date(),
                    id = "chart" + d.valueOf(),
                    bgColor = t.css("backgroundColor"),
                    ctt = '	<canvas id="' + id + '" width="' + w + '" height="' + h + '"></canvas>',
                    param = { download: download, config: config, idx: idx };
                if ("undefined" == typeof type || "undefined" == typeof source) return console.warn("Parâmetros do gráfico não declarados corretamente"), !1;
                t.append(ctt);
                var canvas = $("#" + id).get(0);
                ...
                ctx.clearRect(0, 0, w, h),
                    source.indexOf("remote:") > -1
                        ? $.ajax({
                            ...
                            success: function (i) {
                                t.find(".ps-ico-loading").remove(), (i = psLib.ChartProcessColors(type, i, bgColor)), psLib.ChartBuilder(type, i, ctx, canvas, this.indexValue);
                            },
                        }).error(function () {
                            console.warn("Ocorreu um erro ao carregar os dados do gráfico"), t.find(".ps-ico-loading").remove(), psLib.NotifyShowHide("error:Ocorreu um erro ao processar o gráfico");
                        })
                        : (source.indexOf("function:") > -1 ? (data = eval("(window." + source.replace("function:", "") + ")")) : (data = eval("window." + source)),
                            (data = psLib.ChartProcessColors(type, data, bgColor)),
                            psLib.ChartBuilder(type, data, ctx, canvas, param)),
                    idx++;
            }));
}),
    (psLib.ChartProcessColors = function (t, i, e) {
        var s = i;
        if ("line" == t || "bar" == t || "radar" == t)
            if (1 == s.datasets.length) {
                var o = "undefined" != typeof s.datasets[0].baseColor ? psLib.ChartColorScheme(t, s.datasets[0].baseColor, e) : psLib.ChartColors(t, 1, e);
                $.extend(s.datasets[0], o);
            } else
                for (var n = 0, a = s.datasets.length; a > n; n++) {
                    var o = "undefined" != typeof s.datasets[n].baseColor ? psLib.ChartColorScheme(t, s.datasets[n].baseColor, e) : psLib.ChartColors(t, n, e);
                    $.extend(s.datasets[n], o);
                }
        else
            for (var n = 0, a = s.length; a > n; n++) {
                var o = "undefined" != typeof s[n].baseColor ? psLib.ChartColorScheme(t, s[n].baseColor, e) : psLib.ChartColors(t, n, e);
                $.extend(s[n], o);
            }
        return s;
    }),
    (psLib.ChartColors = function (t, i, e) {
        var s = {};
        return (
            (colors = {
            ...
            "undefined" == typeof colors[t][i] && (i %= colors[t].length),
            (s = psLib.ChartColorScheme(t, colors[t][i], e))
        );
    }),
    (psLib.ChartColorScheme = function (t, i, e) {
        var s = {};
        return (
            i.indexOf("#") > -1 && (i = psLib.ConvertHexToRGB(i)),
            (s =
                "line" == t || "radar" == t
                    ? { fillColor: "rgba(" + i + ",0.2)", strokeColor: "rgba(" + i + ",1)", pointColor: "rgba(" + i + ",1)", pointStrokeColor: e, pointHighlightFill: e, pointHighlightStroke: "rgba(" + i + ",1)" }
                    : "bar" == t
                        ? { fillColor: "rgba(" + i + ",0.5)", strokeColor: "rgba(" + i + ",0.8)", highlightFill: "rgba(" + i + ",0.75)", highlightStroke: "rgba(" + i + ",1)" }
                        : { color: "rgba(" + i + ",1)", highlight: "rgba(" + i + ",0.7)" })
        );
    }),
    ...
    (psLib.ChartImg = function (t, i) {
        var e = window.graph[i].toBase64Image(),
            s = $(t).parent();
        s.addClass("ps-chart-downloadPad").append('<a href="' + e + '" class="ps-chart-download" target="_blank" title="Download"><span class="ps-ico ps-ico-download"></span></a> ');
    }),
    function () {
        "use strict";
        var t = this,
            ...
            e = function (t) {
                ...
                (t.canvas.width = e), (t.canvas.height = o);
        ...
        var s = (e.helpers = {}),
            o = (s.each = function (t, i, e) {
                ...
                if (t)
                    ...
                    } else for (var n in t) i.apply(e, [t[n], n].concat(s));
            }),
            ...
            a = (s.extend = function (t) {
                return (
                    o(Array.prototype.slice.call(arguments, 1), function (i) {
                        o(i, function (e, s) {
            ...
            C =
                ((s.getAngleFromPoint = function (t, i) {
                    ...
                    return 0 > e && 0 > s && (n += 2 * Math.PI), { angle: n, distance: o };
                }),
            ...
            b =
                ((s.calculateScaleRange = function (t, i, e, s, o) {
                    ...
                    for (
                        ...
                        if (w > a) (m *= 2), (w = Math.round(f / m)), w % 1 !== 0 && (h = !0);
                        else if (o && u >= 0) {
                            if ((m / 2) % 1 !== 0) break;
                            (m /= 2), (w = Math.round(f / m));
                        } else (m /= 2), (w = Math.round(f / m));
                    return h && ((w = n), (m = f / w)), { steps: w, stepValue: m, min: p, max: p + w * m };
                }),
                ...
                ((s.generateLabels = function (t, i, e, s) {
                    ...
                    (s.easingEffects = {
                        ...
                        easeInOutBounce: function (t) {
                            return 0.5 > t ? 0.5 * y.easeInBounce(2 * t) : 0.5 * y.easeOutBounce(2 * t - 1) + 0.5;
                        },
                    })),
            ...
            L =
                ((s.animationLoop = function (t, i, e, s, o, n) {
                    var a = 0,
                        h = y[e] || y.linear,
                        l = function () {
                            a++;
                            var e = a / i,
                                r = h(e);
                            t.call(n, r, e, a), s.call(n, r, e), i > a ? (n.animationFrame = S(l)) : o.apply(n);
                        };
                    S(l);
                }),
                    (s.getRelativePosition = function (t) {
                        ...
                        return s.touches ? ((i = s.touches[0].clientX - n.left), (e = s.touches[0].clientY - n.top)) : ((i = s.clientX - n.left), (e = s.clientY - n.top)), { x: i, y: e };
                    }),
            ...
            B = (s.drawRoundedRectangle = function (t, i, e, s, o, n) {
                t.beginPath(),
                    t.moveTo(i + n, e),
                    t.lineTo(i + s - n, e),
                    t.quadraticCurveTo(i + s, e, i + s, e + n),
                    t.lineTo(i + s, e + o - n),
                    t.quadraticCurveTo(i + s, e + o, i + s - n, e + o),
                    t.lineTo(i + n, e + o),
                    t.quadraticCurveTo(i, e + o, i, e + o - n),
                    t.lineTo(i, e + n),
                    t.quadraticCurveTo(i, e, i + n, e),
                    t.closePath();
            });
        (e.instances = {}),
                                ...
                                var c = [],
                                    ...
                                    d = function () {
                                        ...
                                        return (
                                            ...
                                            (o = v(l)),
                                            (i = g(l)),
                                            { x: o > this.chart.width / 2 ? o : i, y: (n + e) / 2 }
                                        );
                                    }.call(this, h);
                                new e.MultiTooltip({
                                    x: d.x,
            ...
            (e.Type.extend = function (t) {
                ...
                if (((s.prototype = n(i.prototype)), a(s.prototype, t), (s.extend = e.Type.extend), t.name || i.prototype.name)) {
                    ...
                    (e.defaults[o] = a(l, t.defaults)),
                        (e.types[o] = s),
                        (e.prototype[o] = function (t, i) {
            ...
            (e.Tooltip = e.Element.extend({
                draw: function () {
                    ...
                    if (((t.fillStyle = this.fillColor), this.custom)) this.custom(this);
                        ...
                        B(t, n, a, e, s, this.cornerRadius), t.fill(), (t.fillStyle = this.textColor), (t.textAlign = "center"), (t.textBaseline = "middle"), t.fillText(this.text, n + e / 2, a + s / 2);
                    }
                },
            })),
            ...
            (e.Scale = e.Element.extend({
                ...
                buildYLabels: function () {
                    this.yLabels = [];
                    for (var t = m(this.stepValue), i = 0; i <= this.steps; i++) this.yLabels.push(b(this.templateString, { value: (this.min + i * this.stepValue).toFixed(t) }));
                ...
                calculateXLabelRotation: function () {
                    ...
                    if (((this.xScalePaddingRight = s / 2 + 3), (this.xScalePaddingLeft = e / 2 > this.yLabelWidth + 10 ? e / 2 : this.yLabelWidth + 10), (this.xLabelRotation = 0), this.display)) {
                        var o,
                            n = z(this.ctx, this.font, this.xLabels);
                        this.xLabelWidth = n;
                        for (var a = Math.floor(this.calculateX(1) - this.calculateX(0)) - 6; (this.xLabelWidth > a && 0 === this.xLabelRotation) || (this.xLabelWidth > a && this.xLabelRotation <= 90 && this.xLabelRotation > 0);)
                            (o = Math.cos(w(this.xLabelRotation))),
                                ...
                                this.xLabelRotation++,
                                (this.xLabelWidth = o * n);
                        this.xLabelRotation > 0 && (this.endPoint -= Math.sin(w(this.xLabelRotation)) * n + 3);
                    ...
                    this.display &&
                        ((t.fillStyle = this.textColor),
                            ...
                            o(
                                this.yLabels,
                                function (o, n) {
                                    var a = this.endPoint - i * n,
                                        h = Math.round(a),
                                        l = this.showHorizontalLines;
                                    (t.textAlign = "right"),
                                        (t.textBaseline = "middle"),
                                        this.showLabels && t.fillText(o, e - 10, a),
                                        0 !== n || l || (l = !0),
                                        l && t.beginPath(),
                            ...
                            o(
                                ...
                                function (i, e) {
                                    var s = this.calculateX(e) + C(this.lineWidth),
                                        o = this.calculateX(e - (this.offsetGridLines ? 0.5 : 0)) + C(this.lineWidth),
                                    ...
                                    0 !== e || a || (a = !0),
                                        ...
                                        a && (t.moveTo(o, this.endPoint), t.lineTo(o, this.startPoint - 3), t.stroke(), t.closePath()),
                                        (t.lineWidth = this.lineWidth),
                                        (t.strokeStyle = this.lineColor),
                                        t.beginPath(),
                                        ...
                                        t.closePath(),
                                        t.save(),
                                        t.translate(s, n ? this.endPoint + 12 : this.endPoint + 8),
                                        t.rotate(-1 * w(this.xLabelRotation)),
                                        (t.font = this.font),
                                        (t.textAlign = n ? "right" : "center"),
                                        (t.textBaseline = n ? "middle" : "top"),
                                        t.fillText(i, 0, 0),
                                        t.restore();
                                },
                                this
                ...
                setScaleSize: function () {
                    ...
                    for (this.ctx.font = W(this.pointLabelFontSize, this.pointLabelFontStyle, this.pointLabelFontFamily), i = 0; i < this.valuesCount; i++)
                        (t = this.getPointPosition(i, d)),
                            (e = this.ctx.measureText(b(this.templateString, { value: this.labels[i] })).width + 5),
                            0 === i || i === this.valuesCount / 2
                                ? ((s = e / 2), t.x + s > p && ((p = t.x + s), (o = i)), t.x - s < g && ((g = t.x - s), (a = i)))
                                : i < this.valuesCount / 2
                                    ? t.x + e > p && ((p = t.x + e), (o = i))
                                    : i > this.valuesCount / 2 && t.x - e < g && ((g = t.x - e), (a = i));
                    (l = g),
                        (r = Math.ceil(p - this.width)),
                        (n = this.getIndexAngle(o)),
                        (h = this.getIndexAngle(a)),
                        (c = r / Math.sin(n + Math.PI / 2)),
                        ...
                        if (
                            (o(
                                ...
                                function (i, e) {
                                    if (e > 0) {
                                        var s,
                                            o = e * (this.drawingArea / this.steps),
                                            n = this.yCenter - o;
                                        if (this.lineWidth > 0)
                                        ...
                                        if (this.showLabels) {
                                            if (((t.font = W(this.fontSize, this.fontStyle, this.fontFamily)), this.showLabelBackdrop)) {
                                                ...
                                                (t.fillStyle = this.backdropColor),
                                                    t.fillRect(this.xCenter - h / 2 - this.backdropPaddingX, n - this.fontSize / 2 - this.backdropPaddingY, h + 2 * this.backdropPaddingX, this.fontSize + 2 * this.backdropPaddingY);
                                            }
        ...
        i.Type.extend({
                ...
                (this.ScaleClass = i.Scale.extend({
                    ...
                    calculateBarX: function (t, i, e) {
                        var o = this.calculateBaseWidth(),
                            n = this.calculateX(e) - o / 2,
                            a = this.calculateBarWidth(t);
                        return n + a * i + i * s.barDatasetSpacing + a / 2;
                    },
            ...
            getBarsAtEvent: function (t) {
                for (
                    ...
                    for (i = 0; i < this.datasets[a].bars.length; i++) if (this.datasets[a].bars[i].inRange(o.x, o.y)) return e.each(this.datasets, n), s;
                return s;
            },
                            ...
                            e.each(
                                ...
                                e.each(
                                    ...
                                    function (t, i) {
                                        ...
                                        (t.controlPoints = e.splineCurve(a(t, h, i), t, n(t, h, i), s)),
                        ...
                        function (i) {
                            ...
                            this.datasets.push(s),
                                e.each(
                                    ...
                                    function (e, o) {
                                        var n;
                                        this.scale.animation || (n = this.scale.getPointPosition(o, this.scale.calculateCenterOffset(e))),
                                            s.points.push(
                                                new this.PointClass({
                                                    value: e,
                                                    label: t.labels[o],
