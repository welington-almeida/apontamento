	...
	<div class="ps-site-container"
		...
		<section>
			...
			<div class="ps-sm-mod4 ps-sm-lspan1 lp-chat-frm"
				...
				<h4 class="ps-heading-4 ps-light">FaÃ§a seu Login</h4>
				</br>
					...
					<div class="ps-row ps-frm-row">
						<div class="ps-mod8 ps-sm-mod12">
							<a href="javascript:;"
								...
								data-validatesuccess="alert('Campos vÃ¡lidos')"><span></span>Login</a>
							</br> <a href="esqueceuSenha.html"
								class="ps-btn ps-btn-primary ps-btn-blue-dark"
								data-validatescope="#validateForm"><span></span>Esqueci
								minha senha</a>
						</div>
					</div>
				</form>
		...
		<footer class="ps-site-foot">
			<div class="ps-container">
				...
				<div class="ps-mod8 ps-sm-mod7 ps-md-mod8"></div>
			</div>
		</footer>
	</div>
