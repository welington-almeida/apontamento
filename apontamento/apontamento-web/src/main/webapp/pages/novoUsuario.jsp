	...
	<div class="ps-site-container"
		...
		<section>
			...
			<div class="ps-sm-mod4 ps-sm-lspan1 lp-chat-frm"
				...
				<br />
				<form action="/apontamento/usuario/inserir" id="validateForm"
					method="POST">
					...
					<div class="ps-row ps-frm-row">
						<div class="ps-mod8 ps-sm-mod12">
							<input required type="password" name="confirmacaoSenha"
					...
					<div class="ps-row ps-frm-row">
						<div class="ps-mod8 ps-sm-mod12">
							<input type="submit" value="Cadastrar"
								class="ps-btn ps-btn-primary ps-btn-blue-dark"> <br />
