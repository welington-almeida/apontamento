					...
					<c:if
						...
						<td><a style="margin-left: 635px; width: 200px;"
							...
							data-modalonhide="console.log('fechar modal')"><span
								class="ps-ico ps-ico-remove"></span> . Encerrar Demanda</a></td>
						<td><a href="javascript:;"
							...
							data-modalonshow="console.log('abrir modal')"
							data-modalonhide="console.log('fechar modal')"><span
								class="ps-ico ps-ico-add"></span> Nova Demanda</a></td>
					</c:if>
				</tr>
			</table>
		</div>
				...
				<thead>
					...
					<tr>
						<th class="ps-sm-mod2" data-type="text"
							data-itemtemplate="PropostaTemplate">ID Demanda</th>
						...
						<th class="ps-hide ps-sm-show ps-sm-mod2">Status</th>
						<th class="ps-hide ps-sm-show ps-sm-mod2" data-type="select"
							data-items="produtos" data-valuefield="id" data-textfield="Name"
							data-sorter="number">Horas Totais</th>
...
<!-- 				</tr> -->
				<tbody>
					...
					<c:forEach items="${demandas}" var="demanda">
						<tr>
							<td class="ps-heading-4 ps-light"><a href="#">${demanda.codigoDemanda}</a><br /></td>
	...
	<div class="ps-modal" id="ModalLarge">
		...
		<div class="ps-modal-container ps-sm-modal-large">
			<div class="ps-modal-title">Nova Demanda</div>
			<div class="ps-modal-content">


				<div class="ps-row">
					<div class="ps-mod8 ps-sm-mod6" style="text-align: center;">
						<form name="demanda" id="validateForm"
							action="/apontamento/demanda/inserir" method="POST">
							<div class="ps-row ps-frm-row">
								<div class="ps-mod8 ps-sm-mod12">
									<label class="ps-frm-lbl">Nome da Demanda</label> <input
										type="text" name="descricao" class="ps-frm-entry ps-frm-valid"
										placeholder="Nome">
								</div>
							</div>
							<div class="ps-row">
	...
	<div class="ps-modal" id="ModalLarge2">
		<a href="javascript:;" class="ps-modal-close ps-modal-close-default"><span
			class="ps-ico ps-ico-sm ps-sm-ico-lg ps-ico-close"></span></a>
		<div class="ps-modal-container ps-sm-modal-large">
			<div class="ps-modal-title">Encerrar Demanda</div>
			<div class="ps-modal-content">
				<div class="ps-row">
					<div class="ps-mod8 ps-sm-mod6" style="text-align: center;">
						<form action="/apontamento/demanda/deletar/" name=""
							id="validateForm" method="POST">
							<div class="ps-frm-select">
								<select name="codigoDemanda">
									<c:forEach items="${demandas}" var="demanda">
										<c:if test="${demanda.status.codigo != 2}">
											<option>${demanda.descricao}</option>
										</c:if>
									</c:forEach>
