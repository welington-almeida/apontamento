			...
			<table>
				<tr>
					...
					<c:if
						...
						<td><a style="margin-left: 650px; width: 200px;"
							...
							data-modalonhide="console.log('fechar modal')"><span
								class="ps-ico ps-ico-remove"></span> Desativar Grupo</a></td>
						<td><a href="javascript:;"
							...
							data-modalonshow="console.log('abrir modal')"
							data-modalonhide="console.log('fechar modal')"><span
								class="ps-ico ps-ico-add"></span> Novo Grupo</a></td>
					</c:if>
				</tr>
			</table>
		</div>
					...
					<thead>
						...
						<tr>
							<th class="ps-sm-mod2" data-type="text"
								data-itemtemplate="PropostaTemplate">ID Grupo</th>
							...
							<th class="ps-hide ps-sm-show ps-sm-mod2" data-type="select"
								data-items="produtos" data-valuefield="id" data-textfield="Name"
								data-sorter="number">Horas Totais <span
								...
								<div class="ps-popover ps-popover-event" id="PopoverHelper1">
									<div class="ps-popover-ctt">As horas totais dos grupos
										são calculadas com base nas horas apontadas em demandas ativas
									</div>
								</div>
							</th>
