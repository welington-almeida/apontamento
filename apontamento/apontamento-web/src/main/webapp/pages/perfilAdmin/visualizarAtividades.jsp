...
<body>
	...
	<jsp:useBean id="demanda"
		class="br.com.porto.controlesinternos.apontamento.model.Demanda" />
	<jsp:useBean id="demandaDAO"
		class="br.com.porto.controlesinternos.apontamento.dao.impl.DemandaDAOImpl" />
		...
		<div class="ps-mod4 ps-sm-mod9">
			<table>
				<tr>
					...
					<c:if
						test="${usuarioLogado.perfil.codigo == '2' || usuarioLogado.perfil.codigo == '3'}">
						<td><a style="margin-left: 635px; width: 200px;"
							class="ps-open-modal ps-btn ps-btn-primary ps-btn-ico"
							style="margin-left: 25px; width: 200px;"
							data-modal="#ModalLarge2" data-modalbackdropstatic="false"
							data-modalkeyboarddisable="true"
							data-modalonshow="console.log('abrir modal')"
							data-modalonhide="console.log('fechar modal')"><span
								class="ps-ico ps-ico-remove"></span> . Encerrar Atividade</a></td>
						<td><a href="javascript:;"
							...
							data-modalonshow="console.log('abrir modal')"
							data-modalonhide="console.log('fechar modal')"><span
								class="ps-ico ps-ico-add"></span> Nova Atividade</a></td>
					</c:if>
				</tr>
			</table>
		</div>
				...
				<thead>
					...
					<tr>
						<th class="ps-sm-mod2" data-type="text"
							data-itemtemplate="PropostaTemplate">ID Atividade</th>
						...
						<th class="ps-hide ps-sm-show ps-sm-mod2" data-type="select"
							data-items="produtos" data-valuefield="id" data-textfield="Name"
							data-sorter="number">Nome da Demanda Pertencente</th>
						<th class="ps-hide ps-sm-show ps-sm-mod2" data-type="select"
							data-items="produtos" data-valuefield="id" data-textfield="Name"
							data-sorter="number">Nome do Grupo Pertencente</th>
						<th class="ps-hide ps-sm-show ps-sm-mod2" data-type="select"
							data-items="produtos" data-valuefield="id" data-textfield="Name"
							data-sorter="number">Status</th>
						<th class="ps-hide ps-sm-show ps-sm-mod2" data-type="select"
							data-items="produtos" data-valuefield="id" data-textfield="Name"
							data-sorter="number">Horas Totais Apontadas</th>
...
<!-- 						<div> -->
<!-- 							</br> </br> <input style="text-align: center" type="text" -->
<!-- 								class="ps-frm-entry" placeholder="Filtrar por ID" value=""> -->
<!-- 						</div> -->
<!-- 					</td> -->
...
<!-- 				</tr> -->
	...
	<div class="ps-modal" id="ModalLarge">
		...
		<div class="ps-modal-container ps-sm-modal-large">
			<div class="ps-modal-title">Nova Atividade</div>
			<div class="ps-modal-content">


				<div class="ps-row">
					<div class="ps-mod8 ps-sm-mod6" style="text-align: center;">
						<form action="/apontamento/atividade/inserir" name=""
							id="validateForm" method="POST">
							<div class="ps-row ps-frm-row">
								<div class="ps-mod8 ps-sm-mod12">
									<label class="ps-frm-lbl">Nome da Atividade</label> <input
										type="text" name="nomeAtividade"
										class="ps-frm-entry ps-frm-valid" placeholder="Nome">
								</div>
							</div>
							<div class="ps-row">
...
<!-- 									</div> -->
									...
									<div class="ps-row ps-frm-row">
										<div class="ps-mod8 ps-sm-mod12">
											<label class="ps-frm-lbl">Horas Estimadas</label> <input
												type="number" name="horasEstimadas"
												class="ps-frm-entry ps-frm-valid"
												placeholder="Estimativa de Horas" value="0">
										</div>
									</div>
								</div>
	...
	<div class="ps-modal" id="ModalLarge2">
		<a href="javascript:;" class="ps-modal-close ps-modal-close-default"><span
			class="ps-ico ps-ico-sm ps-sm-ico-lg ps-ico-close"></span></a>
		<div class="ps-modal-container ps-sm-modal-large">
			<div class="ps-modal-title">Encerrar Atividade</div>
			<div class="ps-modal-content">
				<div class="ps-row">
					<div class="ps-mod8 ps-sm-mod6" style="text-align: center;">
						<form action="/apontamento/atividade/deletar" name=""
							id="validateForm" method="POST">
							<div class="ps-frm-select">
							...
							</br> <input type="submit" value="Encerrar Atividade"
								class="ps-btn ps-btn-primary ps-btn-blue-dark"
								style="width: 200px;" data-validatescope="#validateForm" />
